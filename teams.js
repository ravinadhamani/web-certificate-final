...
[
    ...
    for(var i=0;i<playerList.length;i++){
        if(teamDetails.Name==playerList[i].Team){
    ...
    $('.search-input-box').on("keyup", function() {
      ...
      var imagesArr=[{src:"./imgs/mi.jpg", team: 'MI'},
      {src:"./imgs/csk.jpg", team: 'CSK'},
      {src:"./imgs/dc.jpg", team: 'DC'},
      {src:"./imgs/kings.jpg", team: 'KXIP'},
      {src:"./imgs/kkr.jpg", team: 'KKR'},
      {src:"./imgs/lucknow.jpg", team: 'LSG'},
      {src:"./imgs/rcb.jpg", team: 'RCB'},
      {src:"./imgs/rr.jpg", team: 'RR'},
      {src:"./imgs/ahmedabad lions.jpg", team: 'MI'},
      {src:"./imgs/sunrisers.jpg", team: 'SH'},
    ]

      var maincontainer=document.getElementById("main-container")
      for(var i=0;i<imagesArr.length;i++){
         const teamName=imagesArr[i].team;
    ...
    //   creating the fun to remove the teams photos and having player data
      function gettheidhere(res, team = ''){
          maincontainer.innerHTML=""
          res=res.id
          ...
          <img class="team-img"/>
          <div class="team-text">
              <h3>Team Name :- <h3 class="team-name"> ${teamDetails[charc].name}</h3></h3>
      ...
      player.Name
          ...
          playerDetails.innerHTML= '<div class="playerdetails">' + playerList.map(function (player) {
            return (    `<div> Name: ${player.Name}  </div>
    ...
    //       <img class="team-img"/>
    //       <div class="team-text">
    //           <h3>Player Name :- <h3 class="team-name"> ${playerList[charc].Name}</h3></h3>
    //           <h3> Player Role :- <p class="player-count"> ${playerList[charc].Role}</p></h3>
    //           <h3>Team :- <p class="top-batsman">${playerList[charc].Team}</p></h3>
    //           <h3>Price :- <p class="top-bowler">${playerList[charc].Price}</p></h3>
    //           <h3>Total Matches Won:- <p class="matches">${playerList[charc].pLayingStatus}</p></h3>
    //       </div>
    //         </div>
